...
const plans = [
  {
    ...
    features: [
      ...
      { name: "Train Custom Voice Model (Coming Soon)", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Custom Voice Model - Max 100 (Coming Soon)", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Custom Voice Model - Unlimited (Coming Soon)", included: false },
